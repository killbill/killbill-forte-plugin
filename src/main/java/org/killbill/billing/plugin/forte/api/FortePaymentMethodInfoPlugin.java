...
public class FortePaymentMethodInfoPlugin extends PluginPaymentMethodInfoPlugin {

    public FortePaymentMethodInfoPlugin(final FortePaymentMethodsRecord record) {
        super(UUID.fromString(record.getKbAccountId()),
              UUID.fromString(record.getKbPaymentMethodId()),
              record.getIsDefault() == ForteDao.TRUE,
              record.getToken());
    }
}
